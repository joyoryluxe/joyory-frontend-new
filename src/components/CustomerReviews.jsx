          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-4 px-md-4 py-3 py-md-0">
              {[5, 4, 3, 2, 1].map((star) => {
                ...
                return (
                  <div key={star} className="d-flex align-items-center mb-2 gap-2">
                    ...
                    <div className="progress flex-grow-1" style={{ height: '9px', backgroundColor: '#f0f0f0', borderRadius: '3px' }}>
                      <div
