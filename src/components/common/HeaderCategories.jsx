...
const CATEGORY_PLACEHOLDER = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='400' viewBox='0 0 300 400'><rect width='100%' height='100%' fill='%23f3f4f6'/><text x='50%' y='50%' font-family: 'Montserrat', sans-serif; font-size='14' fill='%239ca3af' dominant-baseline='middle' text-anchor='middle'>Shop Now</text></svg>";

const BRAND_PLACEHOLDER = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='150' height='80' viewBox='0 0 150 80'><rect width='100%' height='100%' fill='%23f3f4f6'/><text x='50%' y='50%' font-family: 'Montserrat', sans-serif; font-size='14' fill='%239ca3af' dominant-baseline='middle' text-anchor='middle'>Brand</text></svg>";
