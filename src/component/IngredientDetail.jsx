      ...
      <div className="ing-detail-page page-title-main-name">
        ...
        <section className="catalog-shelf mt-5">
          ...
          {products.length === 0 ? (
            ...
            <>
              <div className="row row-cols-2 row-cols-md-2 row-cols-lg-4 g-2 g-md-4 text-start">
                {products.map((prod) => {
                  const hasDiscount = prod.discountedPrice && prod.discountedPrice < prod.price;
                  const rawImage = prod.image || prod.images?.[0] || prod.variants?.[0]?.image || prod.variants?.[0]?.images?.[0];
                  ...
                  return (
                    <div key={prod._id} className="col">
                      ...
                      >
                        ...
                        />
                        <div className="card-body d-flex p-2 p-md-3 flex-column justify-content-between">
                          <div>
                          ...
                          <div className="mt-2">
                            <span className="ing-product-price me-2">
