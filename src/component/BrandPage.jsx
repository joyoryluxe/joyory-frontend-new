    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{ height: 265 }}
        >
          <div className="text-muted small mb-1 fw-medium mt-2 text-start">
            {getBrandName(prod)}
          </div>
          <h5
            className="card-title mt-2 align-items-center gap-1 page-title-main-name"
          ...
          {hasVar && (
            <div className="m-0 p-0 ms-0">
              {isVariantSelected ? (
                ...
                >
                  Variant:{" "}
                  <span className="fw-bold text-limit-2">
          ...
          <p
            className="fw-bold mb-3 mt-2 page-title-main-name"
            style={{ fontSize: 16 }}
          >
            {(() => {
              const price =
              ...
              return disc ? (
                <>
                  ...
                  <span
                    style={{ color: "#e53e3e", marginLeft: 8, fontWeight: 600 }}
                  >
                    ({pct}% OFF)
                  </span>
                </>
        ...
        {showVariantOverlay === prod._id && (
          <div
            className="variant-overlay position-absolute"
            onClick={closeVariantOverlay}
          >
            <div
